...
-- INSERT INTO APPLICATIONS.positions (id, title, description, tags)
...
-- INSERT INTO APPLICATIONS.benefits (id, position_id, description) VALUES (1, 1, 'Esto es la descripción de las condiciones de la posición de Arquitecto Software - 1');
-- INSERT INTO APPLICATIONS.benefits (id, position_id, description) VALUES (2, 1, 'Esto es la descripción de las condiciones de la posición de Arquitecto Software - 2');
-- INSERT INTO APPLICATIONS.tasks (id, position_id, description) VALUES (1, 1, 'Coding Java');
-- INSERT INTO APPLICATIONS.tasks (id, position_id, description) VALUES (2, 1, 'Coding Python');
