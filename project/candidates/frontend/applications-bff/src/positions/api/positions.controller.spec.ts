...
describe('PositionController', () => {
  ...
  describe('getAllPositions', () => {
    ...
    it('given positions but no connection to backend, it should return 503 status', async () => {
      positionsService.getPositionById.mockRejectedValue(new PositionsBackendNotAvailableException());
  ...
  describe('getPositionById', () => {
    ...
    it('given a not valid position id, it should return NotFoundException and 404 status', async () => {
      ...
      positionsService.getPositionById.mockRejectedValue(new PositionNotFoundException(99999));
  ...
  function checkPositionDetail(position: PositionDetailDTO | undefined, id: number) {
    if (!position) {
      fail('Position is undefined');
    }
