...
import { PositionsController } from '../src/positions/api/positions.controller';
import { HttpException, HttpStatus } from '@nestjs/common';
import { PositionsService } from '../src/positions/adapters/services/position-service/positions.service';
import { PositionDTO } from '../src/positions/api/dto/positions.dto';
import { PositionDetailDTO, TagDTO } from '../src/positions/api/dto/position-detail.dto';
import {
  PaginatedPositionsDTO,
  PositionServiceDTO,
} from '../src/positions/adapters/services/position-service/dto/service-positions.dto';
import { ErrorDTO } from '../src/shared/api/dto/error.dto';
...
const mockData: PositionServiceDTO[] = [
  {
    ...
    applications: 10,
    createdAt: '2025-01-22T10:23:08.350Z',
  },
  {
    id: 2,
    ...
    applications: 5,
    createdAt: '2025-01-24T10:23:08.350Z',
  },
  {
    id: 3,
    ...
    applications: 12,
    createdAt: '2025-01-26T10:23:08.350Z',
  },
  {
    id: 4,
    ...
    applications: 8,
    createdAt: '2025-01-27T10:23:08.350Z',
  },
  {
    id: 5,
    ...
    applications: 15,
    createdAt: '2025-01-29T10:23:08.350Z',
  },
];

describe('PositionController Tests E2E', () => {
  ...
  function checkPositionDetail(
    ...
    position.requirements?.forEach((requirement) => {
      ...
      expect(requirement).toHaveProperty('mandatory');
    });
