...
- [Demo](#demo)
    - [1) Recruitment and Candidates Apps](#1-recruitment-and-candidates-apps)
    - [2) Creating New Position](#2-recruitment-app-creating-new-position)
    - [3) Position Detail/Edit](#3-recruitment-app-showing-position-detail--edit-position)
    - [4) Candidate View](#4-recruitment-app-candidate-view)
    - [5) Positions List](#5-candidates-app-positions-list)
    - [6) Applying to a Position](#6-candidates-app-applying-to-a-position)
    - [7) Scoring Process](#7-recruitment-scoring-process)
    - [8) Notifications](#8-recruitment-notifications)
    - [9) Analysis and Scoring Information](#9-recruitment-analysis-and-scoring-information)
