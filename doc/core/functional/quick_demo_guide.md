...
- [Demo](#demo)
    ...
    - [Recruitment: Creating New Position](#2-recruitment-app-creating-new-position)
    - [Recruitment; Position Detail/Edit](#3-recruitment-app-showing-position-detail--edit-position)
    - [Recruitment; Candidate View](#4-recruitment-app-candidate-view)
    - [Candidates: Positions List](#5-candidates-app-positions-list)
    - [Candidates: Applying to a Position](#6-candidates-app-applying-to-a-position)
    - [Recruitment; Scoring Process](#7-recruitment-scoring-process)
    - [Recruitment; Notifications](#8-recruitment-notifications)
    - [Recruitment; Analysis and Scoring Information](#9-recruitment-analysis-and-scoring-information)
