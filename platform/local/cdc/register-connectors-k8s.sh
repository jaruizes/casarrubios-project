...
# List of connector files to update
connector_files=(
  "/connectors/recruiters-new-applications-outbox-connector.json"
  "/connectors/recruiters-positions-cdc-connector.json"
  "/connectors/applications-cdc-postgresql-connector.json"
)
...
until curl -s http://cdc-service:8083/connectors/ > /dev/null; do
