...
Donec placerat metus a posuere facilisis. Praesent a massa neque. Vestibulum at nibh pretium, tristique arcu a, varius dui. Pellentesque id tincidunt mauris. Vivamus nec nisi at ex tristique luctus eget sit amet leo. Nam efficitur felis sapien, tempor accumsan nunc auctor quis. Donec semper auctor arcu ut lacinia. Nulla egestas, quam malesuada ultrices ullamcorper, neque turpis aliquam sapien, sit amet tincidunt augue est quis lorem. Duis nec iaculis libero. Nulla ut varius lorem.', '2024-11-28 00:55:04.000000');


INSERT INTO public.requirements (id, position_id, description) VALUES (1, 1,  'Esto es la descripción de los requisitos de la posición de Arquitecto Software - 1');
INSERT INTO public.requirements (id, position_id, description) VALUES (2, 1,  'Esto es la descripción de los requisitos de la posición de Arquitecto Software - 1');
INSERT INTO public.conditions (id, position_id, description) VALUES (1, 1,  'Esto es la descripción de las condiciones de la posición de Arquitecto Software - 1');
INSERT INTO public.conditions (id, position_id, description) VALUES (2, 1,  'Esto es la descripción de las condiciones de la posición de Arquitecto Software - 2');
